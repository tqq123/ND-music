<template>
  <div class="player" v-show="playlist.length>0">
    ...
    <center-tip ref="centerTip">
      <i class="icon-ok"></i>
      <span class="text">{{favoriteTip}}</span>
    </center-tip>
  </div>
</template>
...
<script>
  ...
  import CenterTip from 'base/center-tip/center-tip'
  ...
  export default{
    ...
    methods: {
      ...
      middleTouchMove(e) {
        ...
        this.$refs.middleL.style.opacity = 1 - this.touch.percent   // 设置背景模糊
      ...
      middleTouchEnd() {
        ...
        this.$refs.lyricList.$el.style.opacity = lyricOpacity
